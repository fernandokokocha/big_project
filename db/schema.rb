...
ActiveRecord::Schema.define(version: 20150222165214) do
  ...
  create_table "double_yellow_card_descriptions", force: true do |t|
  ...
  create_table "players", force: true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "team_id"
    t.boolean  "injury_pause"
    t.boolean  "cards_pause"
    t.integer  "strength"
    t.integer  "talent"
  end
